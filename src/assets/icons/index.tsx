...
export const ArrowHeadDownIconFill = (
  style: ImageStyle
): IconElement<ImageProps> => {
  return <Icon {...style} name="arrowhead-down" />;
};

export const ArrowHeadUpIconFill = (
  style: ImageStyle
): IconElement<ImageProps> => {
  return <Icon {...style} name="arrowhead-up" />;
};

export const ArrowIosBackFill = (
  style: ImageStyle
): IconElement<ImageProps> => {
  return <Icon {...style} name="arrow-ios-back" />;
};

export const BulbIconFill = (style: ImageStyle): IconElement<ImageProps> => {
  return <Icon {...style} name="bulb" />;
};
...
export const CartIconOutline = (style: ImageStyle): IconElement<ImageProps> => {
  return <Icon {...style} name="shopping-cart-outline" />;
};

export const CartIconFill = (style: ImageStyle): IconElement<ImageProps> => {
  return <Icon {...style} name="shopping-cart" />;
};

export const ClockIconOutline = (
  style: ImageStyle
): IconElement<ImageProps> => {
  return <Icon {...style} name="clock-outline" />;
};
...
export const GridIconOutline = (style: ImageStyle): IconElement<ImageProps> => {
  return <Icon {...style} name="grid-outline" />;
};
...
export const LayoutIconOutline = (
  ...
  return <Icon {...style} name="layout-outline" />;
};
...
export const MessageCircleIconFill = (
  ...
  return <Icon {...style} name="message-circle" />;
};
...
export const PersonAddIconFill = (
  ...
  return <Icon {...style} name="person-add" />;
};
...
export const StarIconFill = (style: ImageStyle): IconElement<ImageProps> => {
  return <Icon {...style} name="star" />;
};

export const StarIconOutline = (style: ImageStyle): IconElement<ImageProps> => {
  return <Icon {...style} name="star-outline" />;
};

export const FlashIconOutline = (
  style: ImageStyle
): IconElement<ImageProps> => {
  return <Icon {...style} name="flash-outline" />;
};
...
export const MoreVerticalIconFill = (
  ...
  return <Icon {...style} name="more-vertical" />;
};

export const CreditCardIconFill = (
  style: ImageStyle
): IconElement<ImageProps> => {
  return <Icon {...style} name="credit-card" />;
};
