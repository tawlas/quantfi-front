...
import { PaymentCard as PaymentCardModel } from '../../../model';
import { PaymentCard, PaymentCardProps } from '../../../components';
...
class PaymentComponent extends React.Component<PaymentProps> {
  ...
  private renderPaymentCard = (
    item: PaymentCardModel,
    index: number
  ): React.ReactElement<PaymentCardProps> => {
