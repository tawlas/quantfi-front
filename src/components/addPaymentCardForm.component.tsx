...
export type AddPaymentCardFormProps = ThemedComponentProps &
  ViewProps &
  ComponentProps;
...
> {
  ...
  public componentDidUpdate(
    prevProps: AddPaymentCardFormProps,
    prevState: State
  ) {
    ...
    return (
      <View style={[themedStyle.container, style]} {...restProps}>
        ...
        <View style={themedStyle.middleContainer}>
          <ValidationInput
            style={[themedStyle.input, themedStyle.expireInput, { width: 130 }]}
            textStyle={textStyle.paragraph}
            labelStyle={textStyle.label}
        ...
        <ValidationInput
          ...
          textStyle={textStyle.paragraph}
          labelStyle={textStyle.label}
          label="PROPRIETAIRE DE LA CARTE"
...
export const AddPaymentCardForm = withStyles(
  AddNewCardComponent,
  (theme: ThemeType) => ({
